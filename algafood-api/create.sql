create table cidade (id bigint generated by default as identity, nome varchar(255), estado_id bigint not null, primary key (id));
create table cozinha (id bigint generated by default as identity, nome varchar(255), primary key (id));
create table estado (id bigint generated by default as identity, nome varchar(255) not null, primary key (id));
create table forma_pagamento (id bigint generated by default as identity, descricao varchar(255), primary key (id));
create table grupo (id bigint generated by default as identity, descricao varchar(255), primary key (id));
create table grupo_permissoes (grupo_id bigint not null, permissao_id bigint not null);
create table permissao (id bigint generated by default as identity, descricao varchar(255), nome varchar(255), primary key (id));
create table produto (id bigint generated by default as identity, ativo boolean not null, descricao varchar(255), nome varchar(255), preco numeric(19,2), restaurante_id bigint, primary key (id));
create table restaurante (id bigint generated by default as identity, data_atualizacao timestamp not null, data_cadastro timestamp not null, endereco_bairro varchar(255), endereco_cep varchar(255), endereco_complemento varchar(255), endereco_logradouro varchar(255), endereco_numero varchar(255), nome varchar(255) not null, taxa_frete numeric(19,2) not null, cozinha_id bigint not null, endereco_cidade_id bigint, primary key (id));
create table restaurante_forma_pagamento (restaurante_id bigint not null, forma_pagamento_id bigint not null);
create table usuario (id bigint generated by default as identity, data_cadatro timestamp, email varchar(255), nome varchar(255), senha varchar(255), primary key (id));
...
alter table grupo_permissoes add constraint FKbjj8fbcfxr7joapufexdn7fv0 foreign key (permissao_id) references permissao;
alter table grupo_permissoes add constraint FKd7wt9tnvrfttdcl5ofoelgi6j foreign key (grupo_id) references grupo;
